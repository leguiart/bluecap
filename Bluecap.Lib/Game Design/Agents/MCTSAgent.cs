...
namespace Bluecap.Lib.Game_Design.Agents
{
    public class MCTSAgent : BaseAgent
    {
        ...
        */
        ...
        public void GenerateChildren(Node n, BaseGame g)
        {
        ...
        public float Rollout(Node n, BaseGame g)
        {
        ...
        public float UCB(Node node)
        {
            ...
            float RHS = (float)System.Math.Sqrt((float)System.Math.Log(node.parent.selections) / node.selections);
