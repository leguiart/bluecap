...
namespace Bluecap.Lib.Game_Design.Generators
{
    ...
    {
        public GoalOrientedGAGenerator(GenerationSettings settings, IEvaluator<BaseGame> gameEvaluator, GenotypeNoveltyEvaluator noveltyEvaluator, SelectionMethod selectionMethod, int populationSize = 10, int maxIter = 100, int runs = 1, float pc = 0.8F, float pm = 0.01F, float elitism = 0) 
